...
const QAS = [
    ...
    answer: (
      <>
        ...
        <p>
          ...
          Mithra Resumes saves time and prevents formatting mistakes by
  ...
  {
    question:
      "Q2. What uniquely sets Mithra Resumes apart from other resume builders and templates?",
    answer: (
      <>
        <p>
          Other than Mithra Resumes, there are some great free resume builders out
          there, e.g. <Link href="https://rxresu.me/">Reactive Resume</Link>,{" "}
          <Link href="https://flowcv.com/">FlowCV</Link>. However, Mithra Resumes
          stands out with 2 distinctive features:
        </p>{" "}
        <p>
          <span className="font-semibold">
            1. Mithra Resumes is designed specifically for the U.S. job market and
            best practices.
          </span>
          <br />
          Unlike other resume builders that target a global audience and offer
          many customization options, Mithra Resumes intentionally only offers
          ...
          like references. Additionally, Mithra Resumes only offers a top down
          single column resume design as opposed to two column design, because
          single column design works best for AST. <br />{" "}
        </p>
        <p>
          <span className="font-semibold">
            2. Mithra Resumes is super privacy focus.
          </span>{" "}
          <br />
          While other resume builders may require email sign up and store user
          data in their databases, Mithra Resumes believes that resume data should
          remain private and accessible only on user’s local machine. Therefore,
          Mithra Resumes doesn’t require sign up to use the app, and all inputted
  ...
  {
    question: "Q3. Who created Mithra Resumes and why?",
    answer: (
      <p>
        Mithra Resumes was created by{" "}
        ...
        that led to Mithra Resumes, where we integrated best practices and our
        knowledge into this resume builder. Our hope is that Mithra Resumes can help
  ...
  {
    question: "Q4. How can I support Mithra Resumes?",
    answer: (
      <>
        <p>
          The best way to support Mithra Resumes is to share your thoughts and
        ...
        <p>
          Another great way to support Mithra Resumes is by spreading the words.
